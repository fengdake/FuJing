  ...
  >
    <a-spin :spinning="confirmLoading">
      <div class="jiben">
        ...
        <div class="disflex1 chakan-a" v-if="jibenInfoList.jcxx!=null && jibenInfoList.jcxx.length != 0">
          <div class="geren-box" style="width:100%;">
            <div style="display: flex; align-items: center;">
              ...
              <span
                class="title"
                style="display: inline-block;margin-left: 20px;font-size: 14px;"
              >Rewards and Punishments Information</span>
              <img src="~@/assets/sui2.png" alt style="margin-left: 30px;" />
            </div>
            <div class="jindu" style="padding: 40px 24px 24px 24px;">
              <!-- 阶段1 -->
              <div class="jindua" v-for="( itemOne,index ) in jibenInfoList.jcxx " :key="index">
                <div :class="itemOne.end == true ? 'jindubjieshu' : 'jindub'">
                ...
                <div style="width: 100%;">
                  <div class="jinduc">
                    <p class="jinduc_a">
                      ...
                      <span class="timevalue" style="margin-left: 16px;">{{itemOne.sj}}</span>
                    </p>
                    <p class="jinduc_a">
                      <span class="time">具体内容:</span>
                      <!-- <span class="timevalue">{{itemOne.jtnr}}</span> -->
                      <a-textarea class="timevalue" v-model="itemOne.jtnr" :autosize="true" readonly  style="margin-left: 23px;border: none;"/>
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div class="disflex1 chakan-a" v-if="jibenInfoList.grjl!= null &&jibenInfoList.grjl.length != 0">
          <div class="geren-box" style="width:100%;">
            <div style="display: flex; align-items: center;">
              <span class="xian"></span>
              ...
              <img src="~@/assets/sui3.png" alt style="margin-left: 30px;" />
            </div>
            <div class="jindu" style="padding: 40px 24px 24px 24px;">
              <!-- 阶段1 -->
              <div class="jindua" v-for="( itemTwo,index ) in jibenInfoList.grjl " :key="index">
                ...
                <div style="width: 100%;">
                  <div class="jinduc">
                    <p class="jinduc_a">
                      <span class="time">时间:</span>
                      <span class="timevalue" style="margin-left: 16px;">{{itemTwo.ksrq}} ———— {{itemTwo.jsrq}}</span>
                    </p>
                    <p class="jinduc_a">
                      <span class="time">具体内容:</span>
                      <a-textarea class="timevalue" v-model="itemTwo.jtnr" :autosize="true" readonly  style="margin-left: 23px;border: none;"/>
                    </p>
                  </div>
                </div>
              </div>
...
export default {
  ...
  methods: {
    ...
    chaxun(sfzh) {
      ...
      getAction('/rsda/fjJbxx/queryInfo', obj)
        .then(res => {
          if (res.success == true) {
