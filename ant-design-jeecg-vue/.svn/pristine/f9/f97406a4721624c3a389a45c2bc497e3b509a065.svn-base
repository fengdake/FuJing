  ...
  >
    <a-spin :spinning="confirmLoading">
      ...
      <div>
        ...
        >
        <template slot="bgqxx" slot-scope="text" style="width: 100%">
            <font
              :title="text"
              style=" display: inline-block;width:150px;white-space: nowrap;text-overflow: ellipsis;overflow: hidden;line-height: 100%"
            >{{text}}</font>
          </template>
          <template slot="bghxx" slot-scope="text" style="width: 100%">
            <font
              :title="text"
              style=" display: inline-block;width:150px;white-space: nowrap;text-overflow: ellipsis;overflow: hidden;color: rgb(1, 119, 213);line-height: 100%"
            >{{text}}</font>
          </template>
    ...
    return {
      ...
      columns: [
        ...
        },
        {
          ...
          align: 'center',
          dataIndex: 'bgqxx',
          scopedSlots: { customRender: 'bgqxx' }
        },
        {
          title: '变更后信息',
          align: 'center',
