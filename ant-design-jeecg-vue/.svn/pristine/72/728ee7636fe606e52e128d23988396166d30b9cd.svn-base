<template>
  ...
  >
    <a-spin :spinning="confirmLoading">
        ...
        <div class="disflex1 chakan-a">
          <div class="geren-box">
            ...
            <div class="disflex space-between" style="flex-wrap: wrap;padding: 0 14px;">
              <div
                ...
                v-for="(itemOne,index) in fzInfoList.jbxx"
                :key="index"
              >
          ...
          <div class="touxiang-box">
            <img
              ...
              v-if="fzInfoList.txdz == '' || fzInfoList.txdz == null"
              class="touxiang-img"
            />
      ...
      <fzxxsh ref="zsh" :sh="sh" :bs="bs" @close="close"></fzxxsh>
    </a-spin>
  </a-modal>
</template>
...
export default {
  ...
  methods: {
    ...
    edit(record) {
      ...
      that.visible = true
      that.shujv = record
      that.chaxun(record.sfzh) //查询基本信息
    },
    chaxun(sfzh) {
      var that = this
      let obj = {
      ...
      getAction('/rsda/fzxxSpjl/queryInfo', obj)
        .then(res => {
          if (res.success == true) {
