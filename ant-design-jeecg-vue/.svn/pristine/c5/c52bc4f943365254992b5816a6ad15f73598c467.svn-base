<template>
  <div id="userLayout" :class="['user-layout-wrapper', device]">
    <div class="container">
      ...
      <div class="mainbox" style="margin-top: 86px;">
        <div class="logobox">
          <img src="~@/assets/logo2.png" alt style="width: 409px;height: 62px;" />
        </div>
        <div
          class="flex flex-center-between"
          style="margin-top: 100px;align-items: center;justify-content: center;"
        >
      ...
      <div class="xinxi">技术联系人：巩崇龙 联系电话：15380844201</div>
