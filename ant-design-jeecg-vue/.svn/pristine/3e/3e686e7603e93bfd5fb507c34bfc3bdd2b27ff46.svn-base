    ...
    <a-col :md="12" :sm="24">
      <a-card :bordered="false">
        ...
        <a-row style="margin-left: 14px">
          ...
          <a-button @click="handleAdd(1)" type="primary">添加一级单位</a-button>
        </a-row>
      ...
      <a-card :bordered="false">
        <a-form :form="form">
          ...
          <a-form-item
            ...
            :wrapperCol="wrapperCol"
            label="单位编码">
            <a-input :disabled="disable" placeholder="请输入单位编码" v-decorator="['orgCode',validatorRules.orgCode]" />
          </a-form-item>
        ...
        <div class="anty-form-btn">
          <a-button ghost @click="emptyCurrForm" type="default" htmlType="button" icon="sync">重置</a-button>
  ...
  export default {
    ...
    data() {
      return {
        ...
        validatorRules: {
          departName: {rules: [{required: true, message: '请输入单位/部门名称!'}]},
    ...
    methods: {
      ...
      setValuesToForm(record) {
        ...
        this.form.setFieldsValue(pick(record, 'departName', 'orgCode', 'departOrder', 'mobile', 'fax', 'address', 'memo','orgSign','sffs','sfnq','sfxd','status'))
      },
