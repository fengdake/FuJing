<template>
  <div class="main" style="margin: 0 0;margin-top: -60px;width: 420px;">
    <a-form :form="form" class="user-layout-login" ref="formLogin" id="formLogin">
			<a-form-item class="auto">
			  <a-input
					class="inputbg"
			    size="default"
...
<script>
  ...
  export default {
    ...
    created () {
      ...
      Vue.ls.remove("SYS_FLAG")
      Vue.ls.remove("SYS_FLAG_K")
      localStorage.removeItem('lujing')
       localStorage.removeItem('pro__SYS_NAME')
...
//        })
    ...
    methods: {
      ...
      loginSuccess () {
        this.loginBtn = false
        //this.$router.push({ name: "selectSystem" }) //2019.06.11
        // this.$router.push({ name: "dashboard" }) //原 2019.06.11
        Vue.ls.set('SYS_NAME', '')
...
<style lang="scss" scoped>
	.main{display: inline-block;margin-right: 0!important;}
	...
	.auto{ margin: 0 auto;margin-bottom:20px;}
  .user-layout-login {
		box-sizing: border-box;
		text-align: center;
		padding:30px;
