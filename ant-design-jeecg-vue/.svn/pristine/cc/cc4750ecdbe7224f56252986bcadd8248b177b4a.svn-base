<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      <a-button type="primary" icon="download" class="moBan" @click="handleExportXls('辅警基本信息审批记录')">导出</a-button>
    </div>
...
export default {
  ...
  data() {
    return {
      ...
      url: {
        list: '/rsda/fjjbxxSpjl/list',
        delete: '/rsda/fjjbxxSpjl/delete',
        deleteBatch: '/rsda/fjjbxxSpjl/deleteBatch',
        exportXlsUrl: 'rsda/fjjbxxSpjl/exportXls',
        importExcelUrl: 'rsda/fjjbxxSpjl/importExcel'
      }
    }
  },
  created() {
  ...
  methods: {
    ...
    handleChange(value, str) {
      this.queryParam.dacsny = str
      console.log(this.queryParam.dacsny)
    },
    handlePanelChange1(value, mode) {
      console.log(value)
      queryParam.dacsny = value
      this.mode1 = 'month'
    },
    Refresh() {
      this.loadData()
